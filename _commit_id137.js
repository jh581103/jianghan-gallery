...
// 2. 复制缩略图
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\01\\17-49-56-542-asset_20260801-174956-542_f3d4aaccf991_3046e931-1000044337.jpg';
const destThumb = path.join(thumbDir, '旅游_阆中之旅（4）：阆中古城街景实拍.jpg');
...
const newWork = `    {
      "id": 137,
      "title": "旅游_阆中之旅（4）：阆中古城街景实拍",
      "url": "https://weixin.qq.com/sph/ALfaEnGbrZ",
      "thumbnail": "thumbnails/旅游_阆中之旅（4）：阆中古城街景实拍.jpg",
      "description": "2023.8.24 阆中之旅（4），阆中古城街景实拍纪念。",
      "tags": ["江涵原创", "旅游", "视频"],
      "medium": "视频",
      "platform": "视频号",
...
console.log('改 index.html 完成 (id=137)');
...
try {
    execFileSync('git', ['commit', '-m', 'id=137 旅游_阆中之旅（4）：阆中古城街景实拍（2023.8.24阆中之旅（4）阆中古城街景实拍纪念）'], { stdio: 'inherit' });
} catch (e) {
