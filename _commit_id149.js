...
// 2. 复制缩略图
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\01\\19-38-05-992-asset_20260801-193805-992_7dbbf3751df7_a8b4f12b-1000044377.jpg';
const destThumb = path.join(thumbDir, '旅游_成都龙泉石经寺池塘乌龟实拍.jpg');
...
console.log('改 index.html 完成 (id=149)');
...
try {
    execFileSync('git', ['commit', '-m', 'id=149 旅游_成都龙泉石经寺池塘乌龟实拍（2023.8.30成都龙泉石经寺池塘乌龟实拍纪念）'], { stdio: 'inherit' });
} catch (e) {
