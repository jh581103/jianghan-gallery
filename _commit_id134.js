// 录作品 id=134 - 旅游_阆中之旅（1）:成都出发入住酒店实拍
const fs = require('fs');
...
// 2. 复制缩略图
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\01\\17-19-38-792-asset_20260801-171938-792_9d07702e88e3_034688b4-1000044328.jpg';
const destThumb = path.join(thumbDir, '旅游_阆中之旅（1）:成都出发入住酒店实拍.jpg');
...
const newWork = `    {
      "id": 134,
      "title": "旅游_阆中之旅（1）:成都出发入住酒店实拍",
      "url": "https://weixin.qq.com/sph/AnFBuWWfaM",
      "thumbnail": "thumbnails/旅游_阆中之旅（1）:成都出发入住酒店实拍.jpg",
      "description": "2023.8.24 阆中之旅（1），成都出发入住酒店实拍纪念。",
      "tags": ["江涵原创", "旅游", "视频"],
      "medium": "视频",
      "platform": "视频号",
...
console.log('改 index.html 完成 (id=134)');
...
try {
    execFileSync('git', ['commit', '-m', 'id=134 旅游_阆中之旅（1）:成都出发入住酒店实拍（2023.8.24阆中之旅（1）成都出发入住酒店实拍纪念）'], { stdio: 'inherit' });
} catch (e) {
