...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\15-29-04-022-asset_20260802-152904-022_eecf02cb6a92_264b26bb-1000044481.jpg';
const newThumbName = '旅游_万达广场双节彩灯节气浓.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 166,
  title: '旅游_万达广场双节彩灯节气浓',
  url: 'https://weixin.qq.com/sph/AcfXHaxfcm',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '万达广场双节节气浓',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*166\b/.test(html)) {
  console.log('  ⚠️ id=166 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*166\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_万达广场双节彩灯节气浓/g) || []).length;
console.log(`  "id": 166 出现 ${idCount} 次`);
