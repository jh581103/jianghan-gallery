...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\13-54-39-359-asset_20260802-135439-359_5973f7e1884d_f9d6cc30-1000044456.jpg';
const newThumbName = '旅游_剑门关关楼实拍.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 161,
  title: '旅游_剑门关关楼实拍',
  url: 'https://weixin.qq.com/sph/AneSKqOlRW',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '剑门关关楼实拍纪念。',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*161\b/.test(html)) {
  console.log('  ⚠️ id=161 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*161\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_剑门关关楼实拍/g) || []).length;
console.log(`  "id": 161 出现 ${idCount} 次`);
