...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\14-23-16-519-asset_20260802-142316-519_1b411033e63d_488e8c19-1000044471.jpg';
const newThumbName = '旅游_广元四星王朝国际大酒店实拍.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 164,
  title: '旅游_广元四星王朝国际大酒店实拍',
  url: 'https://weixin.qq.com/sph/At1KAalqwT',
...
if (/"id"\s*:\s*164\b/.test(html)) {
  console.log('  ⚠️ id=164 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*164\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_广元四星王朝国际大酒店实拍/g) || []).length;
console.log(`  "id": 164 出现 ${idCount} 次`);
