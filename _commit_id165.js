...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\14-31-20-958-asset_20260802-143120-958_bc8d6eadaf98_371d38ba-1000044475.jpg';
const newThumbName = '旅游_新津老君山实拍.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 165,
  title: '旅游_新津老君山实拍',
  url: 'https://weixin.qq.com/sph/AhyMXCJ4Ie',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '新津老君山实拍纪念。',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*165\b/.test(html)) {
  console.log('  ⚠️ id=165 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*165\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_新津老君山实拍/g) || []).length;
console.log(`  "id": 165 出现 ${idCount} 次`);
