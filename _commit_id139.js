// 录作品 id=139 - 旅游_阆中之旅（六）：阆中古城中天楼上留影
const fs = require('fs');
...
// 2. 复制缩略图
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\01\\18-01-03-986-asset_20260801-180103-986_9210a43586fd_96053466-1000044344.jpg';
const destThumb = path.join(thumbDir, '旅游_阆中之旅（六）：阆中古城中天楼上留影.jpg');
...
console.log('改 index.html 完成 (id=139)');
...
try {
    execFileSync('git', ['commit', '-m', 'id=139 旅游_阆中之旅（六）：阆中古城中天楼上留影（2023.8.24阆中之旅（六）阆中古城中天楼上留影纪念）'], { stdio: 'inherit' });
} catch (e) {
