...
const newThumbName = '旅游_文殊坊街头艺人小提琴独奏.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 186,
  title: '旅游_文殊坊街头艺人小提琴独奏',
  url: 'https://weixin.qq.com/sph/AzgSVGZWko',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '成都文殊坊街头艺人小提琴独奏，琴声悠扬',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*186\b/.test(html)) {
  console.log('  ⚠️ id=186 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*186\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_文殊坊街头艺人小提琴独奏/g) || []).length;
console.log(`  id=186: ${idCount}, title: ${titleCount}`);
