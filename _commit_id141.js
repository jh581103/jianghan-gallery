// 录作品 id=141 - 旅游_阆中之旅（8）：阆中古城滕王阁实拍
const fs = require('fs');
...
// 2. 复制缩略图
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\01\\18-32-41-559-asset_20260801-183241-559_1003cba26b9f_f734b1ae-1000044351.jpg';
const destThumb = path.join(thumbDir, '旅游_阆中之旅（8）：阆中古城滕王阁实拍.jpg');
...
const newWork = `    {
      "id": 141,
      "title": "旅游_阆中之旅（8）：阆中古城滕王阁实拍",
      "url": "https://weixin.qq.com/sph/AVe9wDyJBg",
      "thumbnail": "thumbnails/旅游_阆中之旅（8）：阆中古城滕王阁实拍.jpg",
      "description": "2023.8.25 阆中之旅（8），阆中古城滕王阁实拍纪念。",
      "tags": ["江涵原创", "旅游", "视频"],
      "medium": "视频",
      "platform": "视频号",
...
console.log('改 index.html 完成 (id=141)');
...
try {
    execFileSync('git', ['commit', '-m', 'id=141 旅游_阆中之旅（8）：阆中古城滕王阁实拍（2023.8.25阆中之旅（8）阆中古城滕王阁实拍纪念）'], { stdio: 'inherit' });
} catch (e) {
