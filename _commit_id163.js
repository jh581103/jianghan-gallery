...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\14-15-07-424-asset_20260802-141507-424_0538d8905982_05938279-1000044469.jpg';
const newThumbName = '旅游_西安民宿实拍.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 163,
  title: '旅游_西安民宿实拍',
  url: 'https://weixin.qq.com/sph/A3MPg9QscO',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '西安民宿实拍纪念。',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*163\b/.test(html)) {
  console.log('  ⚠️ id=163 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*163\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_西安民宿实拍/g) || []).length;
console.log(`  "id": 163 出现 ${idCount} 次`);
