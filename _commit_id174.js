...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\18-40-03-364-asset_20260802-184003-364_7d5d090c3e2d_39d898bc-1000044539.jpg';
const newThumbName = '旅游_成都国庆（3）：国庆节成都街景.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 174,
  title: '旅游_成都国庆（3）：国庆节成都街景',
  url: 'https://weixin.qq.com/sph/Al8sF0tqFt',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '成都街景亮起五星，国庆氛围拉满',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*174\b/.test(html)) {
  console.log('  ⚠️ id=174 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*174\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_成都国庆（3）：国庆节成都街景/g) || []).length;
console.log(`  "id": 174 出现 ${idCount} 次`);
