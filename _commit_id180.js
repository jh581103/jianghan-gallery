...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\20-24-24-133-asset_20260802-202424-133_9016b18f48f7_e3baa75b-1000044555.jpg';
const newThumbName = '旅游_成都的蓝天白云.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 180,
  title: '旅游_成都的蓝天白云',
  url: 'https://weixin.qq.com/sph/A8IBiTcL2F',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '今日成都蓝，蓝天白云下的天府广场',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*180\b/.test(html)) {
  console.log('  ⚠️ id=180 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*180\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_成都的蓝天白云/g) || []).length;
console.log(`  "id": 180 出现 ${idCount} 次`);
