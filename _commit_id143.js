// 录作品 id=143 - 旅游_阆中之旅（10）：张飞国际大酒店摆拍留影
const fs = require('fs');
...
// 2. 复制缩略图
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\01\\18-46-09-943-asset_20260801-184609-943_147668287d19_58915dab-1000044357.jpg';
const destThumb = path.join(thumbDir, '旅游_阆中之旅（10）：张飞国际大酒店摆拍留影.jpg');
...
const newWork = `    {
      "id": 143,
      "title": "旅游_阆中之旅（10）：张飞国际大酒店摆拍留影",
      "url": "https://weixin.qq.com/sph/AqhYqezf4L",
      "thumbnail": "thumbnails/旅游_阆中之旅（10）：张飞国际大酒店摆拍留影.jpg",
      "description": "2023.8.25 阆中之旅（10），张飞国际大酒店摆拍留影纪念。",
      "tags": ["江涵原创", "旅游", "视频"],
      "medium": "视频",
      "platform": "视频号",
...
console.log('改 index.html 完成 (id=143)');
...
try {
    execFileSync('git', ['commit', '-m', 'id=143 旅游_阆中之旅（10）：张飞国际大酒店摆拍留影（2023.8.25阆中之旅（10）张飞国际大酒店摆拍留影纪念）'], { stdio: 'inherit' });
} catch (e) {
