...
// 2. 复制缩略图
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\01\\19-32-57-069-asset_20260801-193257-069_3366280a627f_10404632-1000044373.jpg';
const destThumb = path.join(thumbDir, '旅游_成都龙泉石经寺转经筒实拍.jpg');
...
console.log('改 index.html 完成 (id=148)');
...
try {
    execFileSync('git', ['commit', '-m', 'id=148 旅游_成都龙泉石经寺转经筒实拍（2023.8.30成都龙泉石经寺转经筒实拍纪念）'], { stdio: 'inherit' });
} catch (e) {
