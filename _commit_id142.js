// 录作品 id=142 - 旅游_阆中之旅（9）：张飞国际大酒店走个下楼时装步
const fs = require('fs');
...
// 2. 复制缩略图
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\01\\18-39-45-918-asset_20260801-183945-918_0c4818056387_c88bb080-1000044355.jpg';
const destThumb = path.join(thumbDir, '旅游_阆中之旅（9）：张飞国际大酒店走个下楼时装步.jpg');
...
const newWork = `    {
      "id": 142,
      "title": "旅游_阆中之旅（9）：张飞国际大酒店走个下楼时装步",
      "url": "https://weixin.qq.com/sph/AickoS8gPB",
      "thumbnail": "thumbnails/旅游_阆中之旅（9）：张飞国际大酒店走个下楼时装步.jpg",
      "description": "阆中之旅（9），张飞国际大酒店走个下楼时装步纪念。",
      "tags": ["江涵原创", "旅游", "视频"],
      "medium": "视频",
      "platform": "视频号",
...
console.log('改 index.html 完成 (id=142)');
...
try {
    execFileSync('git', ['commit', '-m', 'id=142 旅游_阆中之旅（9）：张飞国际大酒店走个下楼时装步（阆中之旅（9）张飞国际大酒店走个下楼时装步纪念）'], { stdio: 'inherit' });
} catch (e) {
