...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\17-22-09-247-asset_20260802-172209-247_458aaa9beac0_742a8398-1000044523.jpg';
const newThumbName = '旅游_新繁东湖实拍.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 171,
  title: '旅游_新繁东湖实拍',
  url: 'https://weixin.qq.com/sph/AjPGnjLPxh',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '新繁东湖红墙嵌古碑，小桥流水',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*171\b/.test(html)) {
  console.log('  ⚠️ id=171 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*171\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_新繁东湖实拍/g) || []).length;
console.log(`  "id": 171 出现 ${idCount} 次`);
