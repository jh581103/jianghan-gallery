...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\16-25-27-432-asset_20260802-162527-432_93ac1b06d830_e4fe5c84-1000044507.jpg';
const newThumbName = '旅游_东郊记忆（4）：绿皮火车头前拍个照.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 170,
  title: '旅游_东郊记忆（4）：绿皮火车头前拍个照',
  url: 'https://weixin.qq.com/sph/Ay4DRfT5Wp',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '在东郊记忆 1519 号绿皮火车头前留个影',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*170\b/.test(html)) {
  console.log('  ⚠️ id=170 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*170\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_东郊记忆（4）：绿皮火车头前拍个照/g) || []).length;
console.log(`  "id": 170 出现 ${idCount} 次`);
