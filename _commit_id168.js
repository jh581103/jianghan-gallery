...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\16-03-38-160-asset_20260802-160338-160_db6c05c00338_12227e5b-1000044499.jpg';
const newThumbName = '旅游_东郊记忆（2）：都市里的绿皮火车.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 168,
  title: '旅游_东郊记忆（2）：都市里的绿皮火车',
  url: 'https://weixin.qq.com/sph/As2X0DAVbb',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '东郊记忆里的绿皮老火车，停在城市中央，怀旧感十足',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*168\b/.test(html)) {
  console.log('  ⚠️ id=168 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*168\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_东郊记忆（2）：都市里的绿皮火车/g) || []).length;
console.log(`  "id": 168 出现 ${idCount} 次`);
