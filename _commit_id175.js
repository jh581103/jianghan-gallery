...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\19-01-38-999-asset_20260802-190138-999_bb23f2f948c9_a389aab3-1000044542.jpg';
const newThumbName = '旅游_成都国庆（4）：国庆节街景.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 175,
  title: '旅游_成都国庆（4）：国庆节街景',
  url: 'https://weixin.qq.com/sph/AnShnlgKPn',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '国庆夜成都街景，致敬祖国 74 周年',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*175\b/.test(html)) {
  console.log('  ⚠️ id=175 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*175\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_成都国庆（4）：国庆节街景/g) || []).length;
console.log(`  "id": 175 出现 ${idCount} 次`);
