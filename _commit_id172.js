...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\17-30-31-047-asset_20260802-173031-047_b3735101e604_db82604d-1000044526.jpg';
const newThumbName = '旅游_成都国庆川剧表演.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 172,
  title: '旅游_成都国庆川剧表演',
  url: 'https://weixin.qq.com/sph/Afy6ZC5Gb9',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '成都国庆川剧表演现场，民乐齐奏',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*172\b/.test(html)) {
  console.log('  ⚠️ id=172 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*172\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_成都国庆川剧表演/g) || []).length;
console.log(`  "id": 172 出现 ${idCount} 次`);
