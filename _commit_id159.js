...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\13-11-15-607-asset_20260802-131115-607_4b878694a449_266c9a3e-1000044444.jpg';
const newThumbName = '旅游_汉中（7）：乐见一路高速上拉货忙.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 159,
  title: '旅游_汉中（7）：乐见一路高速上拉货忙',
  url: 'https://weixin.qq.com/sph/APyyQYQCwA',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '乐见一路高速上拉货忙纪念。',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*159\b/.test(html)) {
  console.log('  ⚠️ id=159 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*159\b/g) || []).length;
const titleCount = (newHtml.match(/乐见一路高速上拉货忙/g) || []).length;
console.log(`  "id": 159 出现 ${idCount} 次`);
