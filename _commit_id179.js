...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\20-17-05-680-asset_20260802-201705-680_5ca7b36b2462_06e600f0-1000044552.jpg';
const newThumbName = '旅游_成都国庆（8）：国庆兰桂坊夜景.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 179,
  title: '旅游_成都国庆（8）：国庆兰桂坊夜景',
  url: 'https://weixin.qq.com/sph/AB96QEXlH3',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '成都兰桂坊国庆夜，五星装置倒映河中',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*179\b/.test(html)) {
  console.log('  ⚠️ id=179 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*179\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_成都国庆（8）：国庆兰桂坊夜景/g) || []).length;
console.log(`  "id": 179 出现 ${idCount} 次`);
