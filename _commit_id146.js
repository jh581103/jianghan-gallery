...
// 2. 复制缩略图
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\01\\19-05-44-727-asset_20260801-190544-727_6f559f0a2ec1_228f950d-1000044365.jpg';
const destThumb = path.join(thumbDir, '旅游_成都近慈寺实拍.jpg');
...
const newWork = `    {
      "id": 146,
      "title": "旅游_成都近慈寺实拍",
      "url": "https://weixin.qq.com/sph/AxxMUj1wPV",
      "thumbnail": "thumbnails/旅游_成都近慈寺实拍.jpg",
      "description": "2023.8.27 成都近慈寺实拍纪念。",
      "tags": ["江涵原创", "旅游", "视频"],
      "medium": "视频",
      "platform": "视频号",
...
console.log('改 index.html 完成 (id=146)');
...
try {
    execFileSync('git', ['commit', '-m', 'id=146 旅游_成都近慈寺实拍（2023.8.27成都近慈寺实拍纪念）'], { stdio: 'inherit' });
} catch (e) {
