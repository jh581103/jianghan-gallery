...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\14-05-04-716-asset_20260802-140504-716_8067c8455831_3cf2ed2a-1000044460.jpg';
const newThumbName = '旅游_成都晚8点半一环街上车灯似火龙.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 162,
  title: '旅游_成都晚8点半一环街上车灯似火龙',
  url: 'https://weixin.qq.com/sph/ALZNg4gEeg',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '成都一环晚车灯似火龙',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*162\b/.test(html)) {
  console.log('  ⚠️ id=162 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*162\b/g) || []).length;
const titleCount = (newHtml.match(/成都晚8点半一环街上车灯似火龙/g) || []).length;
console.log(`  "id": 162 出现 ${idCount} 次`);
console.log(`  title 部分出现 ${titleCount} 次`);
