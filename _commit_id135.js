...
// 2. 复制缩略图
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\01\\17-26-11-161-asset_20260801-172611-161_90488414f691_0fac867b-1000044330.jpg';
const destThumb = path.join(thumbDir, '旅游_参观张飞庙实拍.jpg');
...
console.log('改 index.html 完成 (id=135)');
...
try {
    execFileSync('git', ['commit', '-m', 'id=135 旅游_参观张飞庙实拍（2023.8.24下午参观张飞庙实拍纪念）'], { stdio: 'inherit' });
} catch (e) {
