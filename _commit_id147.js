...
// 2. 复制缩略图
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\01\\19-11-45-919-asset_20260801-191145-919_8770b0c0a3be_55b4f76b-1000044368.jpg';
const destThumb = path.join(thumbDir, '旅游_成都龙泉石经寺实拍.jpg');
...
console.log('改 index.html 完成 (id=147)');
...
try {
    execFileSync('git', ['commit', '-m', 'id=147 旅游_成都龙泉石经寺实拍（2023.8.30成都龙泉石经寺实拍纪念）'], { stdio: 'inherit' });
} catch (e) {
