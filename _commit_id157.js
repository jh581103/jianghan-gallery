// id=157: 旅游_汉中（5）：欲知秦岭真面目，只缘驰在此山中
const fs = require('fs');
...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\11-27-57-159-asset_20260802-112757-159_f01ce8ad3135_3a507357-1000044435.jpg';
const newThumbName = '旅游_汉中（5）：欲知秦岭真面目，只缘驰在此山中.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 157,
  title: '旅游_汉中（5）：欲知秦岭真面目，只缘驰在此山中',
  url: 'https://weixin.qq.com/sph/AI6rBF87DZ',
...
if (/"id"\s*:\s*157\b/.test(html)) {
  console.log('  ⚠️ id=157 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*157\b/g) || []).length;
const titleCount = (newHtml.match(/欲知秦岭真面目，只缘驰在此山中/g) || []).length;
console.log(`  "id": 157 出现 ${idCount} 次`);
