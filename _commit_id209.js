...
const newThumbName = '旅游_半亩方塘（7）：罗汉园林有个影.jpg';
...
if (/"id"\s*:\s*209\b/.test(html)) { console.log('  ⚠️ id=209 已存在'); process.exit(1); }

const newObjText =
  '\n      {\n' +
  `          "id": 209,\n` +
  `          "title": "旅游_半亩方塘（7）：罗汉园林有个影",\n` +
  `          "url": "https://weixin.qq.com/sph/AM4en0Wcqs",\n` +
  `          "thumbnail": "thumbnails/旅游_半亩方塘（7）：罗汉园林有个影.jpg",\n` +
  `          "description": "温江半亩方塘酒店罗汉园林，月门前留影",\n` +
  `          "tags": [\n` +
  `            "江涵原创",\n` +
  `            "旅游",\n` +
  `            "视频"\n` +
...
const idCount = (newHtml.match(/"id"\s*:\s*209\b/g) || []).length;
console.log(`  id=209 计数: ${idCount}`);
