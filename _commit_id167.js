...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\15-47-15-638-asset_20260802-154715-638_94de71dab292_a0b5c861-1000044491.jpg';
const newThumbName = '旅游_东郊记忆（1）：成都东郊记忆实拍.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 167,
  title: '旅游_东郊记忆（1）：成都东郊记忆实拍',
  url: 'https://weixin.qq.com/sph/AAij5kyf02',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '成都东郊记忆实拍纪念。',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*167\b/.test(html)) {
  console.log('  ⚠️ id=167 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*167\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_东郊记忆（1）：成都东郊记忆实拍/g) || []).length;
console.log(`  "id": 167 出现 ${idCount} 次`);
