...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\19-32-16-997-asset_20260802-193216-997_c01cf47fe083_26001ec4-1000044547.jpg';
const newThumbName = '旅游_成都国庆（6）：天府广场国庆夜景.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 177,
  title: '旅游_成都国庆（6）：天府广场国庆夜景',
  url: 'https://weixin.qq.com/sph/AVUeofxDIN',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '成都天府广场国庆夜，灯火辉煌',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*177\b/.test(html)) {
  console.log('  ⚠️ id=177 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*177\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_成都国庆（6）：天府广场国庆夜景/g) || []).length;
console.log(`  "id": 177 出现 ${idCount} 次`);
