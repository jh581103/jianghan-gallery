// 录作品 id=136 - 旅游_阆中之旅（3）：上两楼观古城全景与嘉陵江美景
const fs = require('fs');
...
// 2. 复制缩略图
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\01\\17-43-46-365-asset_20260801-174346-365_614ee8b1d1b2_a2a3a837-1000044334.jpg';
const destThumb = path.join(thumbDir, '旅游_阆中之旅（3）：上两楼观古城全景与嘉陵江美景.jpg');
...
const newWork = `    {
      "id": 136,
      "title": "旅游_阆中之旅（3）：上两楼观古城全景与嘉陵江美景",
      "url": "https://weixin.qq.com/sph/AivEa88pky",
      "thumbnail": "thumbnails/旅游_阆中之旅（3）：上两楼观古城全景与嘉陵江美景.jpg",
      "description": "2023.8.24 阆中之旅（3），上中天楼观古城全景与嘉陵江美景实拍纪念。",
      "tags": ["江涵原创", "旅游", "视频"],
      "medium": "视频",
      "platform": "视频号",
...
console.log('改 index.html 完成 (id=136)');
...
try {
    execFileSync('git', ['commit', '-m', 'id=136 旅游_阆中之旅（3）：上两楼观古城全景与嘉陵江美景（2023.8.24阆中之旅（3）上中天楼观古城全景与嘉陵江美景实拍纪念）'], { stdio: 'inherit' });
} catch (e) {
