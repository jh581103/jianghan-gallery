// 录作品 id=140 - 旅游_阆中之旅（7）：阆中古城中天楼上录个动态留影
const fs = require('fs');
...
// 2. 复制缩略图
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\01\\18-23-38-341-asset_20260801-182338-341_cffe8fbfaaf8_399f2c1b-1000044348.jpg';
const destThumb = path.join(thumbDir, '旅游_阆中之旅（7）：阆中古城中天楼上录个动态留影.jpg');
...
const newWork = `    {
      "id": 140,
      "title": "旅游_阆中之旅（7）：阆中古城中天楼上录个动态留影",
      "url": "https://weixin.qq.com/sph/A3jOZgyhGa",
      "thumbnail": "thumbnails/旅游_阆中之旅（7）：阆中古城中天楼上录个动态留影.jpg",
      "description": "2023.8.24 阆中之旅（7），阆中古城中天楼上录个动态留影纪念。",
      "tags": ["江涵原创", "旅游", "视频"],
      "medium": "视频",
      "platform": "视频号",
...
console.log('改 index.html 完成 (id=140)');
...
try {
    execFileSync('git', ['commit', '-m', 'id=140 旅游_阆中之旅（7）：阆中古城中天楼上录个动态留影（2023.8.24阆中之旅（7）阆中古城中天楼上录个动态留影纪念）'], { stdio: 'inherit' });
} catch (e) {
