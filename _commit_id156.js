...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\10-40-08-107-asset_20260802-104008-107_245687fb8aa6_09c15c3f-1000044433.jpg';
const newThumbName = '旅游_汉中（4）：天府之门留个影.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 156,
  title: '旅游_汉中（4）：天府之门留个影',
  url: 'https://weixin.qq.com/sph/AoG2L0dy8t',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '汉中（4）天府之门留个影纪念。',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*156\b/.test(html)) {
  console.log('  ⚠️ id=156 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*156\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_汉中（4）：天府之门留个影/g) || []).length;
console.log(`  "id": 156 出现 ${idCount} 次`);
console.log(`  title 出现 ${titleCount} 次（应是 2）`);
