...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\13-20-01-896-asset_20260802-132001-896_ce73e0117fea_39efba46-1000044452.jpg';
const newThumbName = '旅游_汉中（8）：一路山中隧道多.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 160,
  title: '旅游_汉中（8）：一路山中隧道多',
  url: 'https://weixin.qq.com/sph/AZXHHnhsN3',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '一路山中隧道多纪念。',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*160\b/.test(html)) {
  console.log('  ⚠️ id=160 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*160\b/g) || []).length;
const titleCount = (newHtml.match(/一路山中隧道多/g) || []).length;
console.log(`  "id": 160 出现 ${idCount} 次`);
