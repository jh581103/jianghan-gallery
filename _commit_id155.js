...
const srcThumb = 'C:\\Users\\HUAWEI\\.minimax\\v2\\assets\\2026\\08\\02\\10-29-58-803-asset_20260802-102958-803_3483d73fdd80_c1088397-1000044429.jpg';
const newThumbName = '旅游_汉中（3）：南湖杏苑留个影.jpg';
const destThumb = path.join(thumbsDir, newThumbName);

const newWork = {
  id: 155,
  title: '旅游_汉中（3）：南湖杏苑留个影',
  url: 'https://weixin.qq.com/sph/AolgZBZxcT',
  thumbnail: 'thumbnails/' + newThumbName,
  description: '汉中（3）南湖杏苑留个影纪念。',
  tags: ['江涵原创', '旅游', '视频'],
  medium: '视频',
  platform: '视频号',
...
if (/"id"\s*:\s*155\b/.test(html)) {
  console.log('  ⚠️ id=155 已存在，跳过');
} else {
...
const idCount = (newHtml.match(/"id"\s*:\s*155\b/g) || []).length;
const titleCount = (newHtml.match(/旅游_汉中（3）：南湖杏苑留个影/g) || []).length;
console.log(`  "id": 155 出现 ${idCount} 次`);
